...
if __name__ == "__main__":
    ...
    input_data1 = [
     ...
     # Test 1: distances_only, length, brute_force
    result = TSPmainFunc(input_data1, 'distances_only', 'length', 'brute_force')
    print(result)  # Expected output: 80

    # Test 2: distances_with_names, track, brute_force
    result = TSPmainFunc(input_data2, 'distances_with_names', 'track', 'brute_force')
    print(result)  # Expected output: (['A', 'B', 'D', 'C', 'A'], 80)

    # Test 3: distances_only, track, nearest_neighbor
    result = TSPmainFunc(input_data1, 'distances_only', 'track', 'nearest_neighbor')
    print(result)  # Expected output: ([0, 1, 3, 2, 0], 80)
    ...
    # Additional Tests
    # Test 5: distances_only, track, brute_force
    result = TSPmainFunc(input_data1, 'distances_only', 'track', 'brute_force')
    print(result)  # Expected output: ([0, 1, 3, 2, 0], 80)
    ...
    # Test 7: distances_only, length, nearest_neighbor
    result = TSPmainFunc(input_data1, 'distances_only', 'length', 'nearest_neighbor')
    print(result)  # Expected output: 80
